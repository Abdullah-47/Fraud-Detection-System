...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="h-screen w-full bg-[#fff5e9]  flex justify-center items-center text-center font-Onest">
...
const Navbar = () => {
  return (
    <div className="w-full flex justify-between items-center font-Onest p-6 fixed ">
      <h1 className="text-5xl font-bold text-white border-b-2 border-white cursor-pointer hover:text-[#84721A]">
        Fraud <br /> Detection
      </h1>
      <div className="flex flex-col md:flex-row justify-between items-center md:space-x-4 text-xl font-semibold text-white self-start ">
        <a className="text-white hover:text-[#84721A]" href="/login">
          Login
        </a>
        <a className="text-white hover:text-[#84721A]" href="/signup">
          Signup
        </a>
      </div>
    </div>
